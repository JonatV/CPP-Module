...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/19 16:54:31 by jveirman          #+#    #+#             */
/*   Updated: 2024/12/19 16:54:32 by jveirman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	DiamondTrap diamondUS("\e[32mMoneyRichDiamond\e[0m");
	...
	diamondUS.attack(tankGER.getName());
	tankGER.takeDamage(20);
	diamondUS.displayName();
	std::cout << std::endl;
